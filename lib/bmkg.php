		...
		$list = array(
				...
				"13"=>array("province"=>"Kalimantan Barat","xml"=>"/DigitalForecast-KalimantanBarat.xml",
							"data_city"=>array(
										...
										array("area_id"=>"501312","city"=>"Ngabang"),
				...
				"14"=>array("province"=>"Kalimantan Selatan","xml"=>"/DigitalForecast-KalimantanSelatan.xml",
							"data_city"=>array(
										...
										array("area_id"=>"501330","city"=>"Barito Kuala"),
										array("area_id"=>"501563","city"=>"Banjar"),
										array("area_id"=>"501332","city"=>"Balangan"),
										array("area_id"=>"501333","city"=>"Tanah Laut"),
										array("area_id"=>"501334","city"=>"Tapin"),
										array("area_id"=>"501426","city"=>"Tabalong"),
									)
						   ),								
				"15"=>array("province"=>"Kalimantan Tengah","xml"=>"/DigitalForecast-KalimantanTengah.xml",
							"data_city"=>array(
										...
										array("area_id"=>"501346","city"=>"Waringin Timur"),
										array("area_id"=>"501347","city"=>"Sukamara"),
										array("area_id"=>"501348","city"=>"Barito Timur"),
									)
						   ),								
				"16"=>array("province"=>"Kalimantan Timur","xml"=>"/DigitalForecast-KalimantanTimur.xml",
							"data_city"=>array(
										...
										array("area_id"=>"501358","city"=>"Berau"),
										array("area_id"=>"501361","city"=>"Kutai Kartanegara"),
									)
						   ),								
				...
				"19"=>array("province"=>"Lampung","xml"=>"/DigitalForecast-Lampung.xml",
							"data_city"=>array(
										...
										array("area_id"=>"501374","city"=>"Way Kanan"),
										array("area_id"=>"5002236","city"=>"Pesawaran"),
										array("area_id"=>"501375","city"=>"Lampung Tengah"),
										array("area_id"=>"501376","city"=>"Lampung Selatan"),
										array("area_id"=>"501377","city"=>"Tanggamus"),
										array("area_id"=>"501378","city"=>"Lampung Utara"),
										array("area_id"=>"5002237","city"=>"Lampung Barat"),
										array("area_id"=>"501379","city"=>"Lampung Barat"),
										array("area_id"=>"501380","city"=>"Tulang Bawang"),
										array("area_id"=>"501381","city"=>"Metro"),
										array("area_id"=>"5002238","city"=>"Tulang Bawang Barat"),
										array("area_id"=>"5013669","city"=>"Pringsewu"),
										array("area_id"=>"5002234","city"=>"Lampung Timur"),
										array("area_id"=>"5002239","city"=>"Mesuji"),
									)
						   ),								
